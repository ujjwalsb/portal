...
<title>Civil Engineering 7th Semester</title>
</head>
<body>
...
<table border="2" cellpadding="5" align="center"><br><tr>
<th>Enroll</th><th>Name</th><th>Fathers name</th><th>Semester</th><th>BRANCH</th><th>contact</th><th>Registered date</th><th>Paid Amount</th><th>Due Amount</th><th>Commited Date</th>

</tr>
<?php  
include("connect.php");
$sql = "select * from registration Where branch='CE' and semester='7'";
