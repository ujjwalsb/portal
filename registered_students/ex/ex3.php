...
<title>Electrical & Electrinics Engineering 3rd Semester</title>
</head>
<body>
...
<br><tr>
<th>Enrollment</th><th>Name</th><th>Fathers name</th><th>Semester</th><th>BRANCH</th><th>ontact</th><th>Registered date</th><th>Paid Amount</th><th>Due Amount</th><th>Commited Date</th>
</tr>
<?php  
include("connect.php");
$sql = "select * from registration Where branch='EX' and semester='3'";
